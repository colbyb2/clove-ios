        ...
        VStack {
            ...
            ScrollView {
                ...
                VStack(spacing: 15) {
                    ...
                    featureButton(name: "Hydration", icon: "drop.fill", color: Color(hex: "4da3ff"), selected: $vm.baseSettings.trackHydration, animationDelay: 0.5)
                    featureButton(name: "Meals", icon: "fork.knife", color: Color(hex: "72aae5"), selected: $vm.baseSettings.trackMeals, animationDelay: 0.6)
